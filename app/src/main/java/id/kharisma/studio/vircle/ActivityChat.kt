...
import id.kharisma.studio.vircle.Adapter.ChatAdapter
import id.kharisma.studio.vircle.Model.Chat
import id.kharisma.studio.vircle.Model.NotificationData
        ...
        reference!!.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (user.getImage() == "") {
                    ...
                    Glide.with(this@ActivityChat).load(user.getImage()).into(imgProfile)
                }
            }
        })
    ...
    fun readMessage(senderId: String, receiverId: String) {
        ...
        databaseReference.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                val chatAdapter = ChatAdapter(this@ActivityChat, chatList)
